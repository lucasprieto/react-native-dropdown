...
import { Dimensions, StyleSheet, View, ScrollView, TouchableWithoutFeedback, Image } from 'react-native';
...
export default class Select extends Component {
  ...
  render() {
    const { width, height, children, defaultValue, style, styleOption, styleText, placeholder, openImg, closedImg, imgStyle, onLayout } = this.props;
    const { open } = this.state;
    const dimensions = { width, height };
  
    return (
      <TouchableWithoutFeedback onPress={this._onPress.bind(this)} onLayout={onLayout}>
