...
export default class Items extends Component {
  ...
  render() {
    const { items, positionX, positionY, show, onPress, width, height, children, customScrollViewComp, style, autoHeightItemsList } = this.props;
    ...
    const ScrollViewComp = customScrollViewComp
      ...
      : ScrollView
    return (
      <View style={[styles.container, style, { top: positionY, left: positionX }]}>
        <ScrollViewComp
